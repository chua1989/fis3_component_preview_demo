define('common/module/financialsBar/financialsBar.tpl', function(require, exports, module) {
  ...
  if((type == 'novice' || type == 'regular') && Number(interestRaise) > 0){
  	...
  	opt.annualrateText = '<b>' + annualrate + '</b>%';
        ...
        _$out_.push('<div class="financials-item">', opt.topRightTag, '<h3>', opt.tTitle, '</h3><div class="financials-item-timelimit">', opt.tTitleExtra, '</div><div class="financials-item-interestrate">', opt.annualrateText, '</div><div class="financials-item-interestrate-a">预期年化收益率</div><div class="financials-item-intro-extra">', opt.extra, '</div>');
  	...
  	if(!content){
        ...
        _$out_.push('<div class="financials-item-intro">', curInfos.tipText, '</div>', curInfos.progressDom, '<div class="financials-item-operate">');
         if(curInfos.buyAble){ 
        _$out_.push('<a href="/hqb.html" class="wbtn wbtn-big-green">', curInfos.btnText, '</a>');
         }else{ 
        _$out_.push('<a href="/hqb.html" class="wbtn wbtn-big-transparent ', curInfos.finanTimer, '"><img src="', '/static/common/module/financialsBar/financials_clock.png', '"><span>', curInfos.btnText, '</span></a>');
        }
        _$out_.push('</div>');
         } 
        _$out_.push('</div>');
